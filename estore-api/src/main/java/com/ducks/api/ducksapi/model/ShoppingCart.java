...
public class ShoppingCart {
     ...
     * @throws NullPointerException If there is no duck in the shopping cart with
     *                              the passed id
     */
    public void removeItemById(int duckId) throws NullPointerException {
        ...
        throw new NullPointerException(String.format(errorFormat, duckId, this.customerId));
    }
