...
public class UserControllerTest {
    ...
    public void testLoginUser() throws IOException { // loginUser may throw IO Exception
        ...
        // Invoke
        ResponseEntity<Account> response = userController.loginUser(accounts[0].getUsername(), accounts[0].getPlainPassword());
    ...
    public void testLogoutUser() throws IOException { // logoutUser may throw IO Exception
        ...
        // when updateAccount is called return true, simulating successful update and save
    ...
    public void testGetAccountsHandleException() throws IOException { // getAccounts may throw IOException
        // Setup
        // When getAccounts is called on the Mock Hero DAO, throw an IOException
