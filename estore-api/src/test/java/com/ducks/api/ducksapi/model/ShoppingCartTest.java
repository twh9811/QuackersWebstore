...
public class ShoppingCartTest {
    ...
    public void testConstructorWithInvalidMap() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new ShoppingCart(expected_customer_id, expected_items),
    ...
    public void testAddItemAmount() {
        ...
        // addItemAmount - Duck - Negative & 0 Quantity
        assertThrows(IllegalArgumentException.class, () -> cart.addItemAmount(duckThree, -10),
                "IllegalArgumentException was not thrown");
        assertThrows(IllegalArgumentException.class, () -> cart.addItemAmount(duckThree, 0),
                "IllegalArgumentException was not thrown");
        assertEquals(expected_items.size(), cart.getItems().size(), "Cart size is incorrect");
    ...
    public void testRemoveItemAmount() {
        ...
        // removeItemAmount - Duck - Negative & 0 Quantity
        assertThrows(IllegalArgumentException.class, () -> cart.removeItemAmount(duckThree, -10),
                "IllegalArgumentException was not thrown");
        assertThrows(IllegalArgumentException.class, () -> cart.removeItemAmount(duckThree, 0),
                "IllegalArgumentException was not thrown");
        assertEquals(expected_items.size(), cart.getItems().size(), "Cart size is incorrect");
        assertEquals(expected_items.get(3), cart.getItemAmount(duckThree), "Duck 3's quantity is incorrect");

        // removeItemAmount - Duck - More than Available
        assertThrows(IllegalArgumentException.class, () -> cart.removeItemAmount(duckThree, 100),
                "IllegalArgumentException was not thrown");
        assertEquals(expected_items.size(), cart.getItems().size(), "Cart size is incorrect");
        assertEquals(expected_items.get(3), cart.getItemAmount(duckThree), "Duck 3's quantity is incorrect");
